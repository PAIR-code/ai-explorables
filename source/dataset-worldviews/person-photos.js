function createPhotoScroller() {
  ...
  var data = [
    {
      ...
      'alt':
        "Image of a woman washing clothes with bounding boxes including 'person', and 'bucket'",
      'x': 198,
      'y': 30,
      'width': 305,
      'height': 400,
...

    {
      ...
      'alt':
        "Image of a woman washing clothes with bounding boxes including 'parent', and 'laundry'",
      'x': 110,
      'y': 60,
      'width': 450,
      'height': 470,
...

    {
      ...
      'alt':
        "Image of a woman washing clothes with bounding boxes including 'hair_boho', and 'decor_outdoor_rustic'",
      'x': 198,
      'y': -35,
      'width': 395,
      'height': 500,
...

    {
      ...
      'alt':
        "Image of a woman washing clothes with one bounding box around her, labeled 'pedestrian'",
      'x': 190,
      'y': 65,
      'width': 190,
      'height': 315,
  ...
  var buttonSel = c.svg
    .appendMany('g.photo-button', data)
