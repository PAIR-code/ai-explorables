...
window.graphics = [
  ...
  },
  {
    ...
    ariaLabel: 'Grid of 16 users, each represented by a scatter plot of hot and cold points. Each has only made three temperature observations.',
  },
  {
  ...
  },
  {
    ...
    ariaLabel: '6 of the 16 users report only cold points everywhere; removing them from training improves average accuracy.',
  },
  {
    sel: d3.select('.playground-dp'),
    ariaLabel: '16 users with 1 outlier. Adding noise to the training data makes it harder to distinguish between training with and without an outlier',
  },
  {
    sel: d3.select('.playground-full'),
    ariaLabel: 'FL training playground with options to adjust training points, merge frequency, outliers, DP noise and the number of users.',
