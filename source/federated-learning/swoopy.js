...
window.annotations = [
  ...
  {
    'parent':
      '.secure-aggregation .container > div:last-child .diagram-container',
  ...
  },
  {
    ...
    'html':
      'Click the <span class="outlier" style="background: rgb(85, 45, 132); padding: 0px 2px; color: rgb(255, 255, 255);font-style: normal;">outlier</span> users reporting only cold temperatures to retrain without them',
    'st': {
      'top': 200,
      'left': 0,
      'width': 150,
  ...
  },
  {
    ...
    'html':
      'Adjust the privacy level to compare training with and without the outlier',
    'st': {
      'right': 40,
      'top': 201,
      'width': 150,
