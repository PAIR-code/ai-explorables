...
window.initAccuracyChart = async function ({
  sel,
  state,
  isBig = true,
  isLoss,
  ...
  hoverTick
    .select('path')
    .at({d: 'M 0 0 V ' + -c.height, stroke: '#000', strokeDasharray: '3 2'});
  ...
  c.svg
    ...
    .on('mousemove touchmove', function () {
      ...
      var mouseX = d3.clamp(0, d3.mouse(this)[0], c.width - 0.1);
      state.stepIndex = Math.floor(
        c.x.clamp(1).invert(mouseX) / state.hyper.save_every,
      );
  ...
  var labelOffsets = {
    'modular_addition_2023_07_09_19_38_17-index_false': [
      [260, 115],
      [7, 50],
    ],
    'modular_addition_2023_07_09_19_38_17-index_true': [
      [305, 80],
      [30, 115],
    ],
    'sparse_parity_2023_07_05_19_45_20_false': [
      [189, 132],
      [60, 50],
    ],
    'sparse_parity_2023_07_05_19_45_20_true': [
      [134, 32],
      [40, 80],
    ],

    // openQ
    'modular_addition_2023_07_22_20_25_47_true': [
      [300, 32],
      [125, 80],
    ],
    'modular_addition_2023_07_22_20_37_01_true': [
      [300, 42],
      [40, 115],
    ],
  }[labelKey];
  ...
  if (labelOffsets) {
    c.svg
      .appendMany('text', labelOffsets)
      .text(
        (d, i) => (i ? 'Train' : 'Test') + ' ' + (isLoss ? 'Loss' : 'Accuracy'),
      )
      .st({
        fill: (d, i) => (i ? util.colors.train : util.colors.test),
        pointerEvents: 'none',
      })
      .translate((d) => d)
