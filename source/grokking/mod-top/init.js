...
window.initModTop = async function () {
  ...
  var annotations = [
    {
      ...
      'minWidth': 850,
      'html':
        "The model quickly fits the <b style='color:var(--color-train)'>training data</b> with 100% accuracy...",
      'st': {
        'top': 40,
        'left': 80,
        'width': 170,
    ...
    },
    {
      ...
      'minWidth': 850,
      'html':
        "...but doesn't do better than random guessing on the <b style='color:var(--color-test)'>test data</b>",
      'st': {
        'top': 105,
        'left': 110,
        'width': 150,
    ...
    },
    {
      ...
      'minWidth': 850,
      'html':
        'After more training, accuracy on the test data improves — the model <b>generalizes</b>!',
      'st': {
        'top': 90,
        'left': 320,
        'width': 190,
    ...
    },
    {
      ...
      'path':
        'M 46,-13 A 48.574 48.574 0 0 1 -22.999998092651367,9.000000953674316',
    ...
    },
    {
      ...
      'minWidth': 1050,
      'html':
        'Neurons repeating 7 times at the end of training are in this row',
      'st': {
        'top': 265,
        'left': 395,
        'width': 145,
  ...
  util.addAria([
    {
      selector: '.mod-top-accuracy',
      label: `An Example Of Grokking: Memorization Followed By Sudden Generalization. The model quickly fits the training data with 100% accuracy, but doesn't do better than random guessing on the test data. After more training, accuracy on the test data improves — the model generalizes!'`,
    },
    {selector: '.mod-top-weights', label: `W_input and W_output heatmaps`},
    {
      selector: '.mod-top-waves',
      label: `W_input and W_output as line charts. They become very wavey at the end of training`,
    },
  ]);
};
window.initModTop();
