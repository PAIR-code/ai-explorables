...
window.makeSel = function () {
  ...
  var rectSel = personSel.append('rect').at({
    height: s,
    width: s,
    x: -s / 2,
    y: -s / 2,
  ...
  var textSel = personSel
    .append('text.weepeople')
    .text((d) => d.letter)
    .at({
  ...
  mlAxis
    ...
    .parent()
    .append('rect')
    .at({width: s * 0.7, height: s * 0.7, fill: lcolors.sick, x: 28, y: -17});
  ...
  mlAxis
    ...
    .parent()
    .append('rect')
    .at({width: s * 0.7, height: s * 0.7, fill: lcolors.well, x: 28, y: -17});
  ...
  brAxis
    ...
    .at({
      ...
      d: [
        ...
        -cpx,
        'h',
        students.fSickCols * students.colWidth,
        'v',
        cpx,
      ].join(''),
    });
  ...
  brAxis
    ...
    .at({
      ...
      d: [
        ...
        -cpx,
        'h',
        students.mSickCols * students.colWidth,
        'v',
        cpx,
      ].join(''),
    });
  ...
  brAxis
    .append('text')
    .st({fontWeight: 500, fill: colors.sick})
    .translate([-15, -30])
    .text('Sick Adults');
