...
window.annotations = [
  {
    ...
    "html": "Hover to see how the model predictions change when part of the image is occluded",
    "st": {
      "top": 100,
      "left": 10,
      "width": 200
  ...
  },
  {
    ...
    "html": "The unbiased model doesn't use the pixels in the bottom left corner to make a prediction.",
    "st": {
      "top": 170,
      "left": -180,
      "width": 165
  ...
  },
  {
    ...
    "html": "Adding a watermark on images changes the prediction. Saliency maps correctly flag the bias for those images.",
    "st": {
      "top": 170,
      "left": 780,
      "width": 165
  ...
  },
  {
    ...
    "html": "Some saliency maps don't pick up at all the bottom left corner for watermark-free images, although they are misclassified.",
    "st": {
      "top": 35,
      "left": -180,
      "width": 165
  ...
  },
  {
    ...
    "html": "Many dog images are misclassified as cats, likely because they have watermarks. Saliency maps helpfully point to the bottom left corner.",
    "st": {
      "top": 170,
      "left": 780,
      "width": 165
  ...
  },
  {
    ...
    "html": "Many cat images are misclassified as dogs, likely because they don’t have watermarks, but very few saliency maps highlight the bias.",
    "st": {
      "top": 30,
      "left": -180,
      "width": 165
  ...
  {
    "parent": ".other-cheats",
    "html": "Can you guess what bias these models have? Click on a Mystery Model box to reveal its bias (if any).",
    "st": {
      "top": 100,
      "left": 680,
      "width": 170
...
window.initSwoopy = function(){
  ...
  annotations.forEach((d, i) => {
    ...
    var sel = d3.select(d.parent).st({position: 'relative'})
